...
public class IndiviWithoutMandatoryTestng extends SalesforceBase{
    @Test(dataProvider ="IndiviWithoutMandatory")
	public  void runIndiviWithoutMandatoryTestng(String firstName) throws InterruptedException {
		...
		Thread.sleep(5000);
		WebElement newIndividual = driver.findElement(By.xpath("//span[text()='Ne Individual']"));
    ...
    @DataProvider(name="IndiviWithoutMandatory")
	public String[][] fetchData() throws IOException {
		String[][] data ;
		data = ReadExcelData.readSheetData("IndiviWithoutMandatory");
		return data;
    }
